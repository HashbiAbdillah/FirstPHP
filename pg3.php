...
<body style=" background-image: url('https://i.pinimg.com/564x/04/66/9f/04669fca545c07e989a3bb3b54fd6e46.jpg'); background-size: cover; background-repeat: no-repeat; background-attachment: fixed; background-position: center center; font-family: Helvetica, Georgia;">
    <div style="background: rgba(255, 255, 255, 0.2); border: 1px solid rgba(255, 255, 255, 0.2); padding: 20px; border-radius: 10px; backdrop-filter: blur(10px);">
        <h1 style=" font-size: 24px; color:#121212;">SELAMAT DATANG <?php echo $_POST ['first'];?> <?php echo $_POST ['last'];?>!!</h1>
        <p>Jenis kelamin kamu <?php echo $_POST ["pilihan"];?></p>
        <p>Berkewarganegaraan <?php echo $_POST ["Negara"];?></p>
       
       
       
        <p><?php
        if(isset($_POST['language'])) {
            $baaahaaasaaa = $_POST['language'];
    ...
    ?>
        ...
        <p>bio: <?php echo $_POST ["bio"];?></p>            
        <h2 style="font-size: 20px; color:#121212;">Terimakasih <?php echo $_POST ['first'];?> <?php echo $_POST ['last'];?> telah bergabung di Website Kami. Media Belajar kita bersama!</h2>
    </div>
</body>
</html>             